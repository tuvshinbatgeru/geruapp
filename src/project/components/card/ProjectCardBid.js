        ...
        <View style={[styles.container, layout.row]}>
            <View style={[{flex: 1}]}>
                ...
                <View style={[layout.row, layout.centerCenter, ]}>
                  <View style={[layout.row, layout.centerStart, { width: 200, }]}>
                        <Icon name="md-pricetag"
                              size={20}
                              color={"#9299A7"}/>
                        <Text style={{fontFamily: font.regular, marginLeft: 5,}}>Та санал болгосон үнэ</Text>
                  </View>
                  <Text style={[{ fontFamily: font.regular, color: variables.BRAND_RED, flex: 1, }]}>{project.bid_price}₮</Text>
                </View>
                ...
                <View style={[layout.row, layout.centerBetween, { paddingRight: 10, }]}>
                  ...
                  <Text style={[{ fontFamily: font.regular, flex: 1, }]}>{project.end_date}</Text>
                </View>
            </View>
        </View>
      </TouchableHighlight>

...
var DashboardView = function (_Component) {
  babelHelpers.inherits(DashboardView, _Component);

  function DashboardView(props) {
    babelHelpers.classCallCheck(this, DashboardView);
    return babelHelpers.possibleConstructorReturn(this, (DashboardView.__proto__ || Object.getPrototypeOf(DashboardView)).call(this, props));
  }

  babelHelpers.createClass(DashboardView, [{
    key: 'componentWillMount',
    value: function componentWillMount() {}
  }, {
    key: 'newProjectBeforeOpen',
    value: function newProjectBeforeOpen() {
      _reactNativeRouterFlux.Actions.NewProject();
    }
  }, {
    key: 'setBudgetTypeChanged',
    value: function setBudgetTypeChanged(selectedOption, selectedIndex) {}
  }, {
    key: 'render',

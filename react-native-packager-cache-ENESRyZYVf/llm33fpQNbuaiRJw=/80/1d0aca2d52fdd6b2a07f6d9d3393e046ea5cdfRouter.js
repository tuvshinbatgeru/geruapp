...
var _State=require("./State");var _State2=babelHelpers.interopRequireDefault(_State);
var _Reducer=require("./Reducer");var _Reducer2=babelHelpers.interopRequireDefault(_Reducer);
...
var _ActionConst=require("./ActionConst");var ActionConst=babelHelpers.interopRequireWildcard(_ActionConst);var
 ...
 *
 */var propTypes={dispatch:_react.PropTypes.func,backAndroidHandler:_react.PropTypes.func,onBackAndroid:_react.PropTypes.func,onExitApp:_react.PropTypes.func};var
...
function Router(props){babelHelpers.classCallCheck(this,Router);var _this=babelHelpers.possibleConstructorReturn(this,(Router.__proto__||Object.getPrototypeOf(Router)).call(this,
props));
...
}babelHelpers.createClass(Router,[{key:"getChildContext",value:function getChildContext()
...
_scenes=
_react2.default.createElement(_Scene2.default,babelHelpers.extends({
key:"__root",
hideNav:true},
this.props),
...
var children=props.children,styles=props.styles,scenes=props.scenes,reducer=props.reducer,createReducer=props.createReducer,parentProps=babelHelpers.objectWithoutProperties(props,["children","styles","scenes","reducer","createReducer"]);

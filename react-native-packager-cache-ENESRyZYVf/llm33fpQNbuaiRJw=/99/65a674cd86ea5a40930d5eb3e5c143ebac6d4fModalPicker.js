...
exports.default = ModalPicker = _react2.default.createClass({
	displayName: 'ModalPicker',
	...
	setChoosed: function setChoosed(item) {
		...
		if (this.props.multiple) this.forceUpdate();
		if (this.props.closeAfterChoosed) this.closed();
	},
	closed: function closed() {
		this.refs.modal.close();
	},
	_renderItemStyle: function _renderItemStyle(item) {
		var _this = this;
				...
				this.props.options.map(function (item, i) {
					return _react2.default.createElement(
						...
						{ key: i, onPress: function onPress() {
								return _this2.setChoosed(item);
							}, style: styles.item },
						_react2.default.createElement(
							_reactNative.Text,
							{ style: [styles.label, _this2._renderItemStyle(item)] },

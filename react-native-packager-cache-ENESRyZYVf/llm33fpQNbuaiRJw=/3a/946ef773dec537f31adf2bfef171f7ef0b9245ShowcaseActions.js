...
onShowCaseSearchValueCleared=onShowCaseSearchValueCleared;exports.





onShowCaseSearchValueChanged=onShowCaseSearchValueChanged;exports.
...
getPortfolios=getPortfolios;var _ShowcaseConstants=require("./ShowcaseConstants");var BackendFactory=require('../BackendFactory').default;function fetching(type){return{type:_ShowcaseConstants.FETCHING,payload:type};}function onShowCaseSearchValueCleared(){return{type:_ShowcaseConstants.SHOWCASE_SEARCHVALUE_CLEAR};}function onShowCaseSearchValueChanged(text){return function(dispatch){dispatch({type:_ShowcaseConstants.SHOWCASE_SEARCHVALUE_CHANGED,payload:text});BackendFactory().getTagAutocomplete({tag:"hat",freetext:"m"}).then(function(res){dispatch({type:_ShowcaseConstants.GET_TAG_AUTOCOMPLETE_FULFILLED,payload:res.data.tags});}).catch(function(error){});};}function getPortfolios(pageIndex){

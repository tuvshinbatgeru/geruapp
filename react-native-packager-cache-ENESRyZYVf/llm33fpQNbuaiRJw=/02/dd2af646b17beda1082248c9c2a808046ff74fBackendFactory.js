...
BackendFactory;var _env=require("./env");var _env2=babelHelpers.interopRequireDefault(_env);var _Laravel=require("./Laravel");var _Node=require("./Node");function BackendFactory(){var token=arguments.length>0&&arguments[0]!==undefined?arguments[0]:null;

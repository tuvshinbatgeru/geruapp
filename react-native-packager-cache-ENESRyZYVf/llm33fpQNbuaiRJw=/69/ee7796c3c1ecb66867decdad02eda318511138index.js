...
var ModalBox=createReactClass({displayName:"ModalBox",
...
if(this.subscriptions)this.subscriptions.forEach(function(sub){return sub.remove();});
},
...
React.createElement(Animated.View,{style:[styles.absolute,{opacity:this.state.backdropOpacity}]},
...
var content=
React.createElement(View,{style:[styles.transparent,styles.absolute],pointerEvents:'box-none'},
React.createElement(View,{style:{flex:1},pointerEvents:'box-none',onLayout:this.onContainerLayout},
...
return(
React.createElement(Modal,{onRequestClose:function onRequestClose(){return _this6.close();},supportedOrientations:['landscape','portrait'],transparent:true,visible:visible},
content));
...
_this7.setState({});
_this7.animateOpen();
if(_this7.props.backButtonClose&&true)BackButton.addEventListener('hardwareBackPress',_this7.onBackPress);
...
this.animateClose();
if(this.props.backButtonClose&&true)BackButton.removeEventListener('hardwareBackPress',this.onBackPress);
}
}});

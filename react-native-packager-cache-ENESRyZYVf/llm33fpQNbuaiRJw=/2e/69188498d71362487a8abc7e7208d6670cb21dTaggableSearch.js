...
var TaggableSearch = function (_Component) {
  babelHelpers.inherits(TaggableSearch, _Component);

  function TaggableSearch() {
    babelHelpers.classCallCheck(this, TaggableSearch);
    return babelHelpers.possibleConstructorReturn(this, (TaggableSearch.__proto__ || Object.getPrototypeOf(TaggableSearch)).apply(this, arguments));
  }

  babelHelpers.createClass(TaggableSearch, [{
    key: 'render',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              tags.map(function (item) {
                return _react2.default.createElement(
                  _reactNative.TouchableWithoutFeedback,
                  { onPress: _this2.props.onSearchFired },
                  _react2.default.createElement(
                    _reactNative.View,
                    { style: [styles.tagItem, { justifyContent: 'space-between', alignItems: 'center' }] },
                    _react2.default.createElement(
                      _reactNative.Text,
                    ...
                    _react2.default.createElement(
                      ...
                      { style: [{ width: 30, justifyContent: 'center', alignItems: 'flex-end', paddingRight: 5 }] },
                      _react2.default.createElement(
                        _reactNative.View,
                        { style: [_variables.layout.centerCenter, { width: 20, height: 20, borderRadius: 20, backgroundColor: '#fff' }] },
...
exports.default = TaggableSearch;

...
var ProjectCardWorking = function (_Component) {
  babelHelpers.inherits(ProjectCardWorking, _Component);

  function ProjectCardWorking() {
    babelHelpers.classCallCheck(this, ProjectCardWorking);
    return babelHelpers.possibleConstructorReturn(this, (ProjectCardWorking.__proto__ || Object.getPrototypeOf(ProjectCardWorking)).apply(this, arguments));
  }

  babelHelpers.createClass(ProjectCardWorking, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactNative.View,
          { style: [_variables.layout.centerCenter, styles.container] },
          _react2.default.createElement(
            _reactNative.View,
          ...
          _react2.default.createElement(
            _reactNative.View,
            { style: [_variables.layout.row, _variables.layout.centerBetween, { paddingHorizontal: 10, paddingTop: 10, paddingBottom: 3 }] },
            _react2.default.createElement(
              _reactNative.View,
              { style: [_variables.layout.row, { alignItems: 'center', justifyContent: 'flex-start', width: 120 }] },
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactNative.Text,
                { style: [{ fontFamily: _variables.font.bold, marginLeft: 5 }] },
                project.end_date
              )
            )
          ),
          _react2.default.createElement(
            _reactNative.View,
            { style: [_variables.layout.row, _variables.layout.centerBetween, { paddingHorizontal: 10, paddingVertical: 5 }] },
            _react2.default.createElement(
              _reactNative.View,
              { style: [_variables.layout.row, { alignItems: 'center', justifyContent: 'flex-start', width: 120 }] },
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactNative.Text,
                { style: [{ fontFamily: _variables.font.heavy, color: _variables2.default.BRAND_GRAY }] },
                _react2.default.createElement(
                  _reactNative.Text,
                  { style: [{ fontSize: 16, color: _variables2.default.BRAND_BLACK }] },
          ...
          _react2.default.createElement(
            _reactNative.View,
            { style: [_variables.layout.row, _variables.layout.centerCenter, { height: 60, paddingVertical: 20 }] },
            _react2.default.createElement(
              _reactNative.View,
              { style: [_variables.layout.centerCenter, styles.avatarContainer] },
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _reactNative.View,
                { style: [_variables.layout.row, _variables.layout.centerBetween, { flex: 1, paddingRight: 10 }] },
                _react2.default.createElement(_reactNative.View, null),
                _react2.default.createElement(
                  _reactNative.TouchableOpacity,
                  { style: [_variables.layout.centerCenter, { width: 35, height: 35, borderRadius: 35 }] },
  ...
  return ProjectCardWorking;
}(_react.Component);

exports.default = ProjectCardWorking;

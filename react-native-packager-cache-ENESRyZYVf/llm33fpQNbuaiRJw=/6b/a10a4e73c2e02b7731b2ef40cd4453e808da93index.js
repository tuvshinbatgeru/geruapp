...
_react2.default.createElement(_reactNative.Text,{style:[_styles2.default.navBarTitleText,data.style,colorStyle]},
data.title)));
...
{
this.customizeStatusBar();
}},{key:"customizeStatusBar",value:function customizeStatusBar()
...
this.props,containerStyle=_props.containerStyle,tintColor=_props.tintColor,title=_props.title,leftButton=_props.leftButton,rightButton=_props.rightButton,style=_props.style;
...
return(
_react2.default.createElement(_reactNative.View,{style:[_styles2.default.navBarContainer,containerStyle,customTintColor]},
statusBar,
_react2.default.createElement(_reactNative.View,{style:[_styles2.default.navBar,style]},
...
}}]);return NavigationBar;}(_react.Component);NavigationBar.propTypes={style:_reactNative.View.propTypes.style,tintColor:_propTypes2.default.string,statusBar:_propTypes2.default.shape(StatusBarShape),leftButton:_propTypes2.default.oneOfType([_propTypes2.default.shape(ButtonShape),_propTypes2.default.element,_propTypes2.default.oneOf([null])]),rightButton:_propTypes2.default.oneOfType([_propTypes2.default.shape(ButtonShape),_propTypes2.default.element,_propTypes2.default.oneOf([null])]),title:_propTypes2.default.oneOfType([_propTypes2.default.shape(TitleShape),_propTypes2.default.element,_propTypes2.default.oneOf([null])]),containerStyle:_reactNative.View.propTypes.style};NavigationBar.defaultProps={style:{},tintColor:'',leftButton:null,rightButton:null,title:null,statusBar:{style:'default',hidden:false,hideAnimation:'slide',showAnimation:'slide'},containerStyle:{}};exports.default=NavigationBar;
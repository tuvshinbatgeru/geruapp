Object.defineProperty(exports,"__esModule",{value:true});exports.ActionsTest=exports.ActionMap=undefined;var _ActionMap;/**
...
var _Scene=require("./Scene");var _Scene2=babelHelpers.interopRequireDefault(_Scene);
var _ActionConst=require("./ActionConst");var ActionConst=babelHelpers.interopRequireWildcard(_ActionConst);
...
androidBack:ActionConst.ANDROID_BACK},babelHelpers.defineProperty(_ActionMap,
ActionConst.JUMP,ActionConst.JUMP),babelHelpers.defineProperty(_ActionMap,
ActionConst.PUSH,ActionConst.PUSH),babelHelpers.defineProperty(_ActionMap,
ActionConst.REPLACE,ActionConst.REPLACE),babelHelpers.defineProperty(_ActionMap,
ActionConst.BACK,ActionConst.BACK),babelHelpers.defineProperty(_ActionMap,
ActionConst.BACK_ACTION,ActionConst.BACK_ACTION),babelHelpers.defineProperty(_ActionMap,
ActionConst.POP_AND_REPLACE,ActionConst.POP_AND_REPLACE),babelHelpers.defineProperty(_ActionMap,
ActionConst.POP_TO,ActionConst.POP_TO),babelHelpers.defineProperty(_ActionMap,
ActionConst.REFRESH,ActionConst.REFRESH),babelHelpers.defineProperty(_ActionMap,
ActionConst.RESET,ActionConst.RESET),babelHelpers.defineProperty(_ActionMap,
ActionConst.FOCUS,ActionConst.FOCUS),babelHelpers.defineProperty(_ActionMap,
ActionConst.PUSH_OR_POP,ActionConst.PUSH_OR_POP),babelHelpers.defineProperty(_ActionMap,
...
'callback',
'iterate',
'current'].concat(babelHelpers.toConsumableArray(
Object.keys(ActionMap)));


function getInheritProps(props){
// eslint-disable-next-line no-unused-vars
var key=props.key,style=props.style,type=props.type,component=props.component,tabs=props.tabs,sceneKey=props.sceneKey,parent=props.parent,children=props.children,parentProps=babelHelpers.objectWithoutProperties(props,["key","style","type","component","tabs","sceneKey","parent","children"]);
...
}babelHelpers.createClass(Actions,[{key:"iterate",value:function iterate(
...
root.props,children=_root$props.children,component=_root$props.component,staticProps=babelHelpers.objectWithoutProperties(_root$props,["children","component"]);

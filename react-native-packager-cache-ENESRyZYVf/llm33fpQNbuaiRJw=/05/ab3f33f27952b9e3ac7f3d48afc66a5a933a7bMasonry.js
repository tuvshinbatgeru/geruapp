...
var itemWidth = (width - margin * 2) / 2;

var Masonry = function (_Component) {
	babelHelpers.inherits(Masonry, _Component);

	function Masonry(props) {
		babelHelpers.classCallCheck(this, Masonry);

		var _this = babelHelpers.possibleConstructorReturn(this, (Masonry.__proto__ || Object.getPrototypeOf(Masonry)).call(this, props));
	...
	babelHelpers.createClass(Masonry, [{
		...
		key: '_initialColumnsData',
		value: function _initialColumnsData() {
		...
		key: '_calcNextInsertColumn',
		value: function _calcNextInsertColumn() {
			var _state = this.state,
			    columnsData = _state.columnsData,
			    nextInsertColumn = _state.nextInsertColumn;
		...
		key: '_handeScroll',
		value: function _handeScroll(event) {
		...
		key: '_shouldLoadMore',
		value: function _shouldLoadMore(event) {
			return !this.props.loading && this._distanceFromEnd(event) < this.props.distanceToLoadMore;
		}
	}, {
		key: '_distanceToLoadMore',
		value: function _distanceToLoadMore() {
		...
		key: '_distanceFromEnd',
		value: function _distanceFromEnd(event) {
		...
		key: 'defaultLoadingView',
		value: function defaultLoadingView() {
		...
		key: 'calcMasonryColumns',
		value: function calcMasonryColumns() {
			var columnsData = this.state.columnsData;
		...
		value: function render() {
			...
			for (var i = 0; i < columnCount; i++) {
				columns.push(_react2.default.createElement(
					_reactNative.View,
					{ key: i, style: [styles.column, { marginTop: topOffset }] },
					columnsData[i].items.map(function (item, i) {
						return _react2.default.createElement(

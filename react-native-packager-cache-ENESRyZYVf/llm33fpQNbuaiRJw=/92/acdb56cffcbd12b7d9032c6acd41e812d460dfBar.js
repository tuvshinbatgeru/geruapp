  ...
  babelHelpers.createClass(ProgressBar, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          width = _props.width,
          restProps = babelHelpers.objectWithoutProperties(_props, ['borderColor', 'borderRadius', 'borderWidth', 'children', 'color', 'height', 'style', 'unfilledColor', 'width']);
      ...
      return _react2.default.createElement(
        _reactNative.View,
        babelHelpers.extends({ style: [containerStyle, style], onLayout: this.handleLayout }, restProps),

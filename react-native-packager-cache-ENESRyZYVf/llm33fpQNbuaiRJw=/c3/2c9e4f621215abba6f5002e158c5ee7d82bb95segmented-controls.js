...
var _=require("./");var _2=babelHelpers.interopRequireDefault(_);var
...
Platform=_reactNative2.default.Platform;var


SegmentedControls=function(_React$Component){babelHelpers.inherits(SegmentedControls,_React$Component);function SegmentedControls(){babelHelpers.classCallCheck(this,SegmentedControls);return babelHelpers.possibleConstructorReturn(this,(SegmentedControls.__proto__||Object.getPrototypeOf(SegmentedControls)).apply(this,arguments));}babelHelpers.createClass(SegmentedControls,[{key:"render",value:function render()

{
var config=this.getConfig();

return(
_react2.default.createElement(_2.default,babelHelpers.extends({},this.props,{
...
return _react2.default.createElement(View,{style:containerStyle},options);
}},{key:"renderOption",value:function renderOption(

config,option,selected,onSelect,index){
...
var separatorStyle=[baseOptionContainerStyle,borderStyles];var

containerBorderRadius=config.containerBorderRadius,containerBorderWidth=config.containerBorderWidth;
...
return(
_react2.default.createElement(TouchableWithoutFeedback,{onPress:onSelect,key:index,disabled:disabled},
_react2.default.createElement(View,{style:[index>0?separatorStyle:baseOptionContainerStyle,this.props.optionContainerStyle,borderRadiusStyle]},
typeof this.props.renderOption==='function'?this.props.renderOption.call(this,option,selected):
_react2.default.createElement(Text,{allowFontScaling:scaleFont,style:textStyle},label))));




}}]);return SegmentedControls;}(_react2.default.Component);
...
containerBorderRadius:5};exports.default=

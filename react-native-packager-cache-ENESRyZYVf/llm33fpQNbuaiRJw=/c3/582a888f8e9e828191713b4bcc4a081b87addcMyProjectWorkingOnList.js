...
var _ProjectCardWorking = require('./card/ProjectCardWorking');

var _ProjectCardWorking2 = babelHelpers.interopRequireDefault(_ProjectCardWorking);

var MyProjectWorkingOnList = function (_Component) {
  babelHelpers.inherits(MyProjectWorkingOnList, _Component);

  function MyProjectWorkingOnList(props) {
    babelHelpers.classCallCheck(this, MyProjectWorkingOnList);

    var _this = babelHelpers.possibleConstructorReturn(this, (MyProjectWorkingOnList.__proto__ || Object.getPrototypeOf(MyProjectWorkingOnList)).call(this, props));

    _this._renderRowView = _this._renderRowView.bind(_this);
    return _this;
  }

  babelHelpers.createClass(MyProjectWorkingOnList, [{
    key: '_onPress',
    value: function _onPress(data) {}
  }, {
    key: '_renderRowView',
    value: function _renderRowView(rowData) {
      return _react2.default.createElement(_ProjectCardWorking2.default, { project: rowData
      });
    }
  }, {
    ...
    value: function render() {
      return _react2.default.createElement(_reactNativeGiftedListview2.default, {
  ...
  return MyProjectWorkingOnList;
}(_react.Component);

exports.default = MyProjectWorkingOnList;

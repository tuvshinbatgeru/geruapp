...
require('react-native'),View=_require.View,Text=_require.Text,Picker=_require.Picker;
...
var options=locals.options.map(function(_ref){var value=_ref.value,text=_ref.text;return React.createElement(Picker.Item,{key:value,value:value,label:text});});

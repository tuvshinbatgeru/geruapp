...
createToolbarAndroidComponent;var _isEqual=require("lodash/isEqual");var _isEqual2=babelHelpers.interopRequireDefault(_isEqual);var _pick=require("lodash/pick");var _pick2=babelHelpers.interopRequireDefault(_pick);var _react=require("react");var _react2=babelHelpers.interopRequireDefault(_react);var _propTypes=require("prop-types");var _propTypes2=babelHelpers.interopRequireDefault(_propTypes);var _reactNative=require("./react-native");function createToolbarAndroidComponent(
IconNamePropType,
getImageSource)
{var _class,_temp;
...
then(function(icon){return babelHelpers.extends({},action,{icon:icon});});
}

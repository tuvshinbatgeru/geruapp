...
exports.default = ModalDropdown = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      { style: { height: 50 }, onPress: this.props.onPress },
      _react2.default.createElement(
        _reactNative.View,
        { style: [styles.dropdown] },
        _react2.default.createElement(
          _reactNative.Text,
          { style: { fontSize: 16, fontFamily: 'Lato-Regular', color: '#242424' } },
          this.props.title
        ),
        _react2.default.createElement(
          _reactNative.Text,

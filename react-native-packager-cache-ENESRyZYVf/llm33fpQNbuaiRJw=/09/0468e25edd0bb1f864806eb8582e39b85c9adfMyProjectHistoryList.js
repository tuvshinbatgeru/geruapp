...
var _ProjectCardHistory = require('./card/ProjectCardHistory');

var _ProjectCardHistory2 = babelHelpers.interopRequireDefault(_ProjectCardHistory);

var MyProjectHistoryList = function (_Component) {
		babelHelpers.inherits(MyProjectHistoryList, _Component);

		function MyProjectHistoryList(props) {
				babelHelpers.classCallCheck(this, MyProjectHistoryList);

				var _this = babelHelpers.possibleConstructorReturn(this, (MyProjectHistoryList.__proto__ || Object.getPrototypeOf(MyProjectHistoryList)).call(this, props));
		...
		babelHelpers.createClass(MyProjectHistoryList, [{
				key: '_onPress',
				value: function _onPress(data) {}
		}, {
				key: '_renderRowView',
				value: function _renderRowView(rowData) {
						return _react2.default.createElement(_ProjectCardHistory2.default, { project: rowData
						});
				}
		}, {
...
exports.default = MyProjectHistoryList;

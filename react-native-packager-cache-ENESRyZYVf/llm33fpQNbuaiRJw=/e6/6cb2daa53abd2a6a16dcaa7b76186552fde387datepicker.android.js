...
require('react-native'),View=_require.View,Text=_require.Text,DatePickerAndroid=_require.DatePickerAndroid,TimePickerAndroid=_require.TimePickerAndroid,TouchableNativeFeedback=_require.TouchableNativeFeedback;
...
var error=locals.hasError&&locals.error?React.createElement(Text,{accessibilityLiveRegion:"polite",style:errorBlockStyle},locals.error):null;
var value=locals.value?React.createElement(Text,{style:dateValueStyle},formattedValue):null;

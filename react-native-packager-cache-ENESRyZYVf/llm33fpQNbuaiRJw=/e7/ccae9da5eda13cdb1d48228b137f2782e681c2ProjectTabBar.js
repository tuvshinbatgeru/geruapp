...
var ProjectTabBar = _react2.default.createClass({
  displayName: 'ProjectTabBar',
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      _reactNative.View,
      { style: [styles.tabs, false ? styles.fixedTabs : '', this.props.style] },
      this.props.tabs.map(function (tab, i) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _reactNative.Text,
              { style: [styles.tabText, _this2.props.activeTab === i ? styles.activeTab : ''],
                ref: function ref(text) {
                  _this2.tabIcons[i] = text;
                } },
              tab
            )
          )

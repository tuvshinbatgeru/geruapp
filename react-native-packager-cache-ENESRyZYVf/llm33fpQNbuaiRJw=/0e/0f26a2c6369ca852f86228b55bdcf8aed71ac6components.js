Object.defineProperty(exports,"__esModule",{value:true});exports.List=undefined;var _react=require("react");var _react2=babelHelpers.interopRequireDefault(_react);
var _tcombValidation=require("tcomb-validation");var _tcombValidation2=babelHelpers.interopRequireDefault(_tcombValidation);
...
case'irreducible':
return(
type===_tcombValidation2.default.Boolean?Checkbox:
type===_tcombValidation2.default.Date?DatePicker:
Textbox);
...
return{
asc:sortByText,
desc:function desc(a,b){return-sortByText(a,b);}}[
order];
}var

Component=function(_React$Component){babelHelpers.inherits(Component,_React$Component);

function Component(props){babelHelpers.classCallCheck(this,Component);var _this=babelHelpers.possibleConstructorReturn(this,(Component.__proto__||Object.getPrototypeOf(Component)).call(this,
props));
_this.typeInfo=(0,_util.getTypeInfo)(props.type);
_this.state={
hasError:false,
value:_this.getTransformer().format(props.value)};return _this;

}babelHelpers.createClass(Component,[{key:"getTransformer",value:function getTransformer()
...
this.setState({value:value},function(){return _this2.props.onChange(value,_this2.props.ctx.path);});
}},{key:"getValidationOptions",value:function getValidationOptions()
...
}},{key:"isValueNully",value:function isValueNully()

{
return Nil.is(this.getValue());
}},{key:"removeErrors",value:function removeErrors()

{
this.setState({hasError:false});
}},{key:"pureValidate",value:function pureValidate()
...
return result;
}},{key:"getAuto",value:function getAuto()

{
return this.props.options.auto||this.props.ctx.auto;
}},{key:"getI18n",value:function getI18n()

{
return this.props.options.i18n||this.props.ctx.i18n;
}},{key:"getDefaultLabel",value:function getDefaultLabel()
...
}},{key:"getStylesheet",value:function getStylesheet()

{
return this.props.options.stylesheet||this.props.ctx.stylesheet;
}},{key:"getLocals",value:function getLocals()
...
}}]);return Component;}(_react2.default.Component);



Component.transformer={
format:function format(value){return Nil.is(value)?null:value;},
parse:function parse(value){return value;}};
...
this.typeInfo.innerType===_tcombValidation2.default.Number?Textbox.numberTransformer:
Textbox.transformer;
...
Textbox.transformer={
format:function format(value){return Nil.is(value)?'':value;},
parse:toNull};


Textbox.numberTransformer={
format:function format(value){return Nil.is(value)?'':String(value);},
...
format:function format(value){return Nil.is(value)?false:value;},
parse:function parse(value){return value;}};var
...
}},{key:"getNullOption",value:function getNullOption()

{
return this.props.options.nullOption||{value:'',text:'-'};
}},{key:"getEnum",value:function getEnum()
...
return{
format:function format(value){return Nil.is(value)&&nullOption?nullOption.value:String(value);},
parse:function parse(value){return nullOption&&nullOption.value===value?null:value;}};
...
}},{key:"getTemplates",value:function getTemplates()
...
}},{key:"getTypeProps",value:function getTypeProps()
...
}},{key:"getInputs",value:function getInputs()

{var _props=
this.props,ctx=_props.ctx,options=_props.options;
...
List=exports.List=function(_Component6){babelHelpers.inherits(List,_Component6);

function List(props){babelHelpers.classCallCheck(this,List);var _this15=babelHelpers.possibleConstructorReturn(this,(List.__proto__||Object.getPrototypeOf(List)).call(this,
props));
_this15.state.keys=_this15.state.value.map(function(){return props.ctx.uidGenerator.next();});return _this15;
}babelHelpers.createClass(List,[{key:"componentWillReceiveProps",value:function componentWillReceiveProps(
...
{var _this16=this;
this.setState({hasError:false});
Object.keys(this.refs).forEach(function(ref){return _this16.refs[ref].removeErrors();});
}},{key:"getValue",value:function getValue()
...
value,keys,path,kind){var _this17=this;
...
}},{key:"onItemChange",value:function onItemChange(

itemIndex,itemValue,path,kind){
...
}},{key:"moveUpItem",value:function moveUpItem(

i){
if(i>0){
this.onChange(
(0,_util.move)(this.state.value.slice(),i,i-1),
(0,_util.move)(this.state.keys.slice(),i,i-1),
this.props.ctx.path.concat(i),
'moveUp');

}
}},{key:"moveDownItem",value:function moveDownItem(
...
{var _this18=this;var _props2=
this.props,options=_props2.options,ctx=_props2.ctx;
var auto=this.getAuto();
var i18n=this.getI18n();
var config=this.getConfig();
var stylesheet=this.getStylesheet();
...
List.transformer={
format:function format(value){return Nil.is(value)?noarr:value;},
parse:function parse(value){return value;}};var


Form=function(_React$Component2){babelHelpers.inherits(Form,_React$Component2);function Form(){babelHelpers.classCallCheck(this,Form);return babelHelpers.possibleConstructorReturn(this,(Form.__proto__||Object.getPrototypeOf(Form)).apply(this,arguments));}babelHelpers.createClass(Form,[{key:"validate",value:function validate()
...
return'0';
}},{key:"getUIDGenerator",value:function getUIDGenerator()

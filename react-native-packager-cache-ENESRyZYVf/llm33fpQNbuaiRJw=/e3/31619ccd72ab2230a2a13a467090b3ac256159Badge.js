...
var Badge = function (_Component) {
    ...
    function Badge(props) {
        ...
        var _this = babelHelpers.possibleConstructorReturn(this, (Badge.__proto__ || Object.getPrototypeOf(Badge)).call(this, props));
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { ref: function ref(component) {
                        return _this2._container = component;
        ...
        value: function _renderChildren() {
            ...
            return _react2.default.Children.map(this.props.children, function (child) {
                if (!_react2.default.isValidElement(child)) {
                    return _react2.default.createElement(
                        _reactNative.Text,
                        { onLayout: _this3._onLayout, style: [styles.text, _this3.props.textStyle] },
                        child
                    );
                }
                return child;
...
Badge.propTypes = {
    extraPaddingHorizontal: _react.PropTypes.number,

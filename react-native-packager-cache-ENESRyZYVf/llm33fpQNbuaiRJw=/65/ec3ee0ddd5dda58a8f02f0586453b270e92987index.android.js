...
this.props,children=_props.children,colors=_props.colors,end=_props.end,locations=_props.locations,start=_props.start,style=_props.style,otherProps=babelHelpers.objectWithoutProperties(_props,["children","colors","end","locations","start","style"]);
...
return(
_react2.default.createElement(_reactNative.View,babelHelpers.extends({ref:function ref(component){_this2.gradientRef=component;}},otherProps,{style:style}),
...
}}]);return LinearGradient;}(_react.Component);LinearGradient.propTypes=babelHelpers.extends({start:_propTypes2.default.oneOfType([_reactNative.PointPropType,deprecatedPropType(_propTypes2.default.arrayOf(_propTypes2.default.number),'Use point object with {x, y} instead.')]),end:_propTypes2.default.oneOfType([_reactNative.PointPropType,deprecatedPropType(_propTypes2.default.arrayOf(_propTypes2.default.number),'Use point object with {x, y} instead.')]),colors:_propTypes2.default.arrayOf(_propTypes2.default.string).isRequired,locations:_propTypes2.default.arrayOf(_propTypes2.default.number)},_reactNative.ViewPropTypes);exports.default=LinearGradient;

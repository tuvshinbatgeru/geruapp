...
var _reactNativeAnimatedButton = require('../../components/react-native-animated-button');

var _reactNativeAnimatedButton2 = babelHelpers.interopRequireDefault(_reactNativeAnimatedButton);

var _reactNativeAnimatedOverlay = require('../../components/react-native-animated-overlay');

var _reactNativeAnimatedOverlay2 = babelHelpers.interopRequireDefault(_reactNativeAnimatedOverlay);
...
var NewProjectDetailComponent = function (_Component) {
  babelHelpers.inherits(NewProjectDetailComponent, _Component);

  function NewProjectDetailComponent(props) {
    babelHelpers.classCallCheck(this, NewProjectDetailComponent);

    var _this = babelHelpers.possibleConstructorReturn(this, (NewProjectDetailComponent.__proto__ || Object.getPrototypeOf(NewProjectDetailComponent)).call(this, props));
  ...
  babelHelpers.createClass(NewProjectDetailComponent, [{
    key: 'validate',
    ...
    value: function saveProject() {
      ...
      Promise.resolve(this.props.actions.checkProjectValidation()).then(function (res) {
        var project = _this2.props.project;
        ...
        _this2.props.actions.saveProject(project.form, project.selectedPriceBundle, project.selectedDurationType, project.durationValue, project.getIn(['tags', 'selected']));
      });
    }
  }, {
    key: 'onChange',
    ...
    key: 'imageUploaded',
    value: function imageUploaded(data) {
      this.props.actions.newProjectImageUploaded(data);
    }
  }, {
    key: 'imageRemoved',
    value: function imageRemoved(data) {
      this.props.actions.newProjectImageRemoved(data);
    }
  }, {
    key: 'toggleShowPriceChooser',
    value: function toggleShowPriceChooser(toggle) {
      this.setState({
        showPriceChooser: toggle
      });
    }
  }, {
    key: 'toggleSkillChooser',
    value: function toggleSkillChooser(toggle) {
      this.setState({
        showSkillChooser: toggle
      });
    }
  }, {
    key: 'toggleShowDurationChooser',
    value: function toggleShowDurationChooser(toggle) {
      this.setState({
        showDurationTypeChooser: toggle
      });
    }
  }, {
    key: 'toggleShowDurationValueChooser',
    value: function toggleShowDurationValueChooser(toggle) {
      this.setState({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_ProjectForm2.default, {
              ...
              onChange: function onChange(value, path) {
                return _this3.onChange(value, path);
              } })
          ),
          _react2.default.createElement(_ModalDropdown2.default, { title: "Төсөв: ",
            ...
            onPress: function onPress() {
              return _this3.toggleShowPriceChooser(true);
            } }),
          _react2.default.createElement(
            _reactNative.View,
            { style: styles.durationBundleContainer },
            _react2.default.createElement(_ModalDropdown2.default, { title: "Төрөл: ",
              ...
              onPress: function onPress() {
                return _this3.toggleShowDurationChooser(true);
              } }),
            _react2.default.createElement(_ModalDropdown2.default, { title: "Хугацаа: ",
              ...
              onPress: function onPress() {
                return _this3.toggleShowDurationValueChooser(true);
              } })
          )
        ),
        _react2.default.createElement(_reactNativeAnimatedButton2.default, { text: '\u0422\u04E9\u0441\u04E9\u043B \u043D\u0438\u0439\u0442\u043B\u044D\u0445',
          ...
          onPress: function onPress() {
            return _this3.saveProject();
          }
        }),
        _react2.default.createElement(
          _reactNativeAnimatedOverlay2.default,
          { isOpen: project.get('fetched')
          },
          _react2.default.createElement(
            _reactNative.View,
            ...
            _react2.default.createElement(
              _reactNative.View,
              { style: [_variables.layout.centerCenter, { flex: 4 }] },
              _react2.default.createElement(
                _reactNative.Text,
                { style: [_variables.layout.label, { fontSize: 24, color: '#66cc22' }] },
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                { style: [_variables.layout.centerCenter, { backgroundColor: _variables2.default.BRAND_COLOR, borderRadius: 40, paddingVertical: 10 }],
                  activeOpacity: 0.9,
                  onPress: this.props.onForwardAction
                },
                _react2.default.createElement(
                  _reactNative.Text,
                  { style: { color: '#fff', fontSize: 24, fontFamily: _variables2.default.FONT_HEAVY } },
                  'I GET IT'
                )
              )
            )
        ...
        _react2.default.createElement(_ModalPicker2.default, { options: project.fixedPriceBundles,
          ...
          onClosed: function onClosed() {
            return _this3.toggleShowPriceChooser(false);
          },
          title: '\u0422\u04E9c\u04E9\u0432 \u0441\u043E\u043D\u0433\u043E\u0445',
          onChange: function onChange(item) {
            return _this3.priceChoosed(item);
          },
          ...
          label: function label(item) {
            return item.description + ' - ' + item.min_amount + ' - ' + item.max_amount + ' ₮';
          } }),
        _react2.default.createElement(_ModalPicker2.default, { options: project.durationTypes,
          ...
          onClosed: function onClosed() {
            return _this3.toggleShowDurationChooser(false);
          },
          title: '\u0410\u0436\u0438\u043B \u04AF\u0440\u0433\u044D\u043B\u0436\u0438\u043B\u044D\u0445 \u0442\u04E9\u0440\u04E9\u043B \u0441\u043E\u043D\u0433\u043E\u0445',
          onChange: function onChange(item) {
            return _this3.durationTypeChoosed(item);
          },
        ...
        _react2.default.createElement(_ModalPicker2.default, { options: this.chooseDurationOptions(),
          ...
          onClosed: function onClosed() {
            return _this3.toggleShowDurationValueChooser(false);
          },
          title: '\u0425\u0443\u0433\u0430\u0446\u0430\u0430 \u0441\u043E\u043D\u0433\u043E\u0445',
          onChange: function onChange(item) {
            return _this3.durationValueChoosed(item);
          },
...
exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(NewProjectDetailComponent);
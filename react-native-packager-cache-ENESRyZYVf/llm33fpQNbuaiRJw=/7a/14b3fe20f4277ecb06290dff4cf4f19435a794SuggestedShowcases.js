...
var SuggestedShowcases = function (_Component) {
	babelHelpers.inherits(SuggestedShowcases, _Component);

	function SuggestedShowcases() {
		babelHelpers.classCallCheck(this, SuggestedShowcases);
		return babelHelpers.possibleConstructorReturn(this, (SuggestedShowcases.__proto__ || Object.getPrototypeOf(SuggestedShowcases)).apply(this, arguments));
	}

	babelHelpers.createClass(SuggestedShowcases, [{
		key: '_loadMore',
		...
		key: '_onRowRender',
		value: function _onRowRender(item) {
	...
	return SuggestedShowcases;
}(_react.Component);

exports.default = SuggestedShowcases;

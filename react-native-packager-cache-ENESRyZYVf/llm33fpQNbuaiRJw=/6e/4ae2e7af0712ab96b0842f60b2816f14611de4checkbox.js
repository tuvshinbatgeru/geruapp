...
require('react-native'),View=_require.View,Text=_require.Text,Switch=_require.Switch;
...
style:checkboxStyle,
onValueChange:function onValueChange(value){return locals.onChange(value);},
value:locals.value}),

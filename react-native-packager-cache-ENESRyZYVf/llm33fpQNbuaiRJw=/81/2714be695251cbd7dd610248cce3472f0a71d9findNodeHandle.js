...
// Composite
component.render!=null&&typeof component.render==='function',"findNodeHandle(...): Argument is not a component (type: %s, keys: %s)",
...
invariant(
false,"findNodeHandle(...): Unable to find node handle for unmounted component.");

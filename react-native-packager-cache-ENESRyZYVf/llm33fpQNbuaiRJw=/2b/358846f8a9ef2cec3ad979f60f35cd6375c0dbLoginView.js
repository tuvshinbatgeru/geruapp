...
var _LoginRender = require('../components/LoginRender');

var _LoginRender2 = babelHelpers.interopRequireDefault(_LoginRender);
...
var LoginView = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var onButtonPress = buttonPressHandler.bind(null, this.props.actions.login, this.props.auth.form.fields.username, this.props.auth.form.fields.password);

    return _react2.default.createElement(_LoginRender2.default, {
